            ...
            if st.checkbox("🔑 Am uitat parola", key="show_forgot"):
                ...
                if st.session_state.get("fp_question"):
                    ...
                    fnew, fnew2 = _pw_field(
                        "Parolă nouă (min. 4 caractere)", "fp_newpw",
                        confirm=True, confirm_label="Confirmă parola nouă",
                    )
...
AMBIENT_LIBRARY = {
    ...
    # ── 🆕 Sunete ambientale noi (2026-08) ─────────────────────────────
    # 🐾 Animale și natură
    "🦌 Cerbi în pădure": "deer",
    "🦊 Vulpe pe furiș": "fox",
    "🦉 Bufniță noaptea": "owl",
    "🦆 Rațe pe lac": "ducks",
    "🕊️ Porumbei în piață": "pigeons",
    "🐦‍⬛ Corbi croncănind": "ravens",
    "🦗 Insecte de vară": "insects",
    "🌱 Foșnet de iarbă": "grass",
    "🍃 Frunze foșnind": "leaves",
    "🌳 Ramuri în vânt": "branches",
    "🍃 Adiere ușoară": "breeze",
    # 🌊 Apă și mare
    "⛲ Susur de fântână": "fountain_water",
    "🌊 Clipocit de apă": "water_lap",
    "🪨 Valuri pe stânci": "waves_rocks",
    "🕳️ Peșteră marină": "sea_cave",
    "💦 Pleoscăit în apă": "splash",
    "💧 Aspersoare în grădină": "sprinkler",
    "⚓ Port cu bărci": "harbor",
    "🗼 Far pe mare": "lighthouse",
    "🛶 Ponton pe lac": "pontoon",
    "🚣 Vâsle în apă": "oars",
    "🐚 Scoici la mal": "shells",
    "🎣 La pescuit liniște": "fishing",
    # 🌦️ Vreme
    "🌦️ Burniță ușoară": "drizzle",
    "🧊 Grindină": "hail",
    "🌨️ Lapoviță": "sleet",
    "🌫️ Ceață densă": "fog",
    "🌧️ Ploaie în depărtare": "distant_rain",
    "⛈️ Furtună îndepărtată": "distant_storm",
    "❄️ Atmosferă rece": "cold_atmos",
    "🔥 Atmosferă caldă": "warm_atmos",
    # 🕐 Momente ale zilei
    "🌅 Dimineață devreme": "morning",
    "🌤️ După-amiază tihnită": "afternoon",
    "🌆 Seară blândă": "evening",
    "🌄 Răsărit calm": "morning_atmos",
    "🌙 Atmosferă de noapte": "night_atmos",
    # 🎬 Locuri publice
    "🎬 Sală de cinema": "cinema",
    "🎶 Concert live": "concert",
    "🕺 Club de noapte": "club",
    "🎭 Sală de teatru": "theater",
    "🏨 Hol de hotel": "hotel",
    "🛎️ Recepție hotel": "reception",
    "🛍️ Mall aglomerat": "mall_space",
    "💼 Birou open-space": "office_space",
    "🏫 Sală de clasă": "classroom",
    "💇 Salon de coafură": "salon_space",
    "🅿️ Parcare subterană": "parking",
    # 🏠 Camere și spații
    "🏚️ Mansardă liniștită": "attic",
    "🧱 Pivniță răcoroasă": "basement",
    "🪟 Balcon deschis": "balcony",
    "🔧 Garaj": "garage",
    "🛖 Cabană de munte": "cabin",
    "🏛️ Sală mare cu ecou": "big_room",
    "🚪 Cameră mică": "small_room",
    "📦 Cameră goală": "empty_room",
    "🚶 Hol cu ecou": "hall",
    "🪜 Casa scării": "staircase",
    # 🚂 Transport
    "🚂 În tren": "train_interior",
    "🚋 Tramvai în mers": "tram",
    "🚇 Peron de metrou": "metro_station",
    "✈️ Cabină de avion": "plane_cabin",
    "⛵ Barcă pe apă": "boat_idle",
    "🏙️ Oraș agitat": "busy_city",
    "🌃 Trafic de noapte": "night_traffic",
    "🌆 Oraș liniștit seara": "quiet_city",
    # 🎭 Atmosferă și stare
    "💕 Romantic": "romance",
    "🕯️ Misterios": "mysterious",
    "🤫 Tăcere tensionată": "silence_tension",
    "🧘 Relaxare profundă": "relaxation",
    "🌳 Leagăn în grădină": "swing",
    "🪑 Balansoar pe verandă": "rocking_chair",

    # ══════════════════════════════════════════════════════════════════
    # 🆕🆕 Sunete realiste noi (2026-08, lot complet) — voci reale din viață
    # ══════════════════════════════════════════════════════════════════
    # 🚂 Tren și șine
    "🚂 Tren accelerând": "train_accel",
    "🚂 Tren frânând": "train_brake",
    "🚂 Tren plecând din gară": "train_depart",
    "🚪 Uși de tren": "train_doors",
    "🚂 Tren care trece": "train_pass",
    "🚉 Gară cu trenuri": "train_station",
    "🚪 Ușă de tren": "door_train",
    "📢 Anunț în transport": "transport_announce",
    "📢 Anunț în gară": "station_announce",
    "🚉 Mulțime în gară": "crowd_station",
    # 🚗 Mașini și drum
    "🚗 Portieră de mașină": "car_door",
    "🚗 Portbagaj": "car_trunk",
    "🚗 Geam de mașină coborât": "car_window",
    "🔒 Centură de siguranță": "seatbelt",
    "🚚 Motor diesel": "engine_diesel",
    "🔋 Motor electric": "engine_electric",
    "🚗 Ștergătoare de parbriz": "wipers",
    "🚗 Mașini în depărtare": "distant_cars",
    "📯 Claxon în depărtare": "distant_horn",
    "🚨 Sirenă în depărtare": "distant_siren",
    "🚦 Semafor pentru pietoni": "crosswalk",
    "🚦 Semafor sonor": "traffic_light",
    "🚧 Lucrări în stradă": "roadwork",
    "🔨 Picamer": "jackhammer",
    "🚌 Uși de autobuz": "bus_doors",
    "🛴 Trotinetă": "trotinette",
    "🌊 Jet ski": "jet_ski",
    "🚤 Barcă accelerând": "boat_accel",
    "⚓ Lanț de ancoră": "anchor_chain",
    # ✈️ Aeroport și bagaje
    "✈️ Aeroport aglomerat": "airport_extra",
    "✈️ Ușă de avion": "door_plane",
    "🧳 Bandă de bagaje": "baggage_belt",
    "🧳 Cărucior de bagaje": "luggage_cart",
    "🧳 Ridicat bagaj": "luggage_lift",
    "🧳 Valiză deschisă": "suitcase_open",
    "🧳 Valiză cu roți": "suitcase_wheels",
    "🧳 Fermoar de valiză": "suitcase_zip",
    # 🚪 Uși, porți, comutatoare
    "🚪 Ușă închisă încet": "door_close",
    "🚪💥 Ușă trântită": "door_slam",
    "🚪 Ușă scârțâind": "door_creak_open",
    "🚪 Clanță apăsată": "door_handle",
    "🚪 Ușă de cameră": "door_room",
    "🚪 Ușă de balcon": "door_balcony",
    "🚪 Ușă de baie": "door_bathroom",
    "🚪 Ușă de dulap": "door_cabinet",
    "🧊 Ușă de frigider": "door_fridge",
    "🔥 Ușă de cuptor": "door_oven",
    "🛗 Ușă de lift": "door_lift",
    "🚪 Ușă de garaj": "garage_door",
    "🏥 Ușă de clinică": "clinic_door",
    "🚧 Poartă deschisă": "gate_open",
    "🚧 Poartă închisă": "gate_close",
    "🚧 Poartă de lemn": "gate_wood",
    "🚪 Dulap deschis": "closet",
    "🪟 Tras perdeaua": "curtain_draw",
    "💡 Întrerupător de lumină": "switch_flip",
    "✊ Bătaie în ușă": "knock",
    "🚪 Ceva închis": "close",
    # 🔑 Chei, bani, mărunțișuri
    "🔑 Zornăit de chei": "keys_jingle",
    "🔑 Chei căzând": "keys_drop",
    "🔑 Chei puse pe masă": "keys_put",
    "🔑 Chei în geantă": "keys_bag",
    "🔑 Scotocit după chei": "keys_rummage",
    "🪙 Zornăit de monede": "coins",
    "💵 Numărat bani": "money",
    "👛 Portofel deschis": "wallet",
    "💳 Card trecut prin POS": "card_swipe",
    "🔘 Nasture": "button",
    "🔘 Apăsare de buton": "button_press",
    "📎 Agrafă de birou": "paperclip",
    "🎗️ Elastic": "rubber_band",
    "🔗 Cataramă de curea": "belt_buckle",
    # 💄 Machiaj și îngrijire
    "💄 Deschis trusa de machiaj": "makeup_open",
    "💄 Închis trusa de machiaj": "makeup_close",
    "💄 Pompă de fond de ten": "foundation_pump",
    "💄 Anticearcăn": "concealer",
    "👁️ Dat cu rimel": "mascara",
    "✏️ Creion de sprâncene": "brow_pencil",
    "✨ Aplicat bronzant": "bronzer",
    "🖌️ Pensulă de machiaj": "brush_sweep",
    "🖌️ Pensulă lovită ușor": "brush_tap",
    "🖌️ Perie rotativă": "rotating_brush",
    "🌸 Disc demachiant": "cotton_pad",
    "💆 Mască de față": "face_mask",
    "🧴 Aplicat cremă": "cream_apply",
    "🧴 Cremă de mâini": "hand_cream",
    "💧 Picurat ser": "serum_drop",
    "🧴 Pompă de cosmetice": "cosmetic_pump",
    "🧴 Stors tub de cremă": "tube_squeeze",
    "💨 Pulverizator fin": "spray_mist",
    "🌸 Pulverizare parfum": "perfume_spray",
    "🌸 Parfum pe încheietură": "perfume_wrist",
    "🧴 Spray de corp": "body_spray",
    "🧴 Spray deodorant": "deodorant_spray",
    "🧴 Deodorant roll-on": "roll_on",
    "🧴 Deodorant stick": "stick_deo",
    "💇 Fixativ de păr": "hair_spray",
    "💇 Placă de îndreptat părul": "flat_iron",
    "💇 Pieptene pus jos": "comb_put",
    "✂️ Tuns părul": "hair_cut",
    "✂️ Mașină de tuns": "clippers",
    "💈 Epilator": "epilator",
    "🪒 Aparat de ras": "razor",
    "🪒 Aparat de ras electric": "electric_razor",
    "🪞 Oglindă aburită": "mirror_steam",
    # 💅 Unghii
    "💅 Pilă de unghii": "nail_file",
    "💅 Unghieră": "nail_clipper",
    "💅 Împins cuticulele": "cuticle",
    "💅 Deschis oja": "polish_open",
    "💅 Agitat sticluța de ojă": "polish_shake",
    "💅 Pensulă de ojă": "polish_brush",
    "👁️ Lipit gene false": "lash_glue",
    "🔧 Pensetă": "tweezers",
    # 💍 Bijuterii
    "💍 Cutie de bijuterii deschisă": "jewelry_box_open",
    "💍 Cutie de bijuterii închisă": "jewelry_box_close",
    "💍 Zornăit de bijuterii": "jewelry_clink",
    "📿 Colier": "necklace",
    "👂 Cercei": "earrings",
    "📿 Brățară": "bracelet",
    "💍 Inel pus jos": "ring_put",
    # 🧥 Haine și încălțăminte
    "👕 Împăturit haine": "clothes_fold",
    "👕 Haine puse jos": "clothes_put",
    "🛍️ Pungă cu haine": "clothes_bag",
    "👗 Îmbrăcat": "dressing",
    "👗 Foșnet de material": "fabric_rustle",
    "🧥 Fermoar de geacă": "jacket_zip",
    "👢 Fermoar de cizmă": "boot_zip",
    "👜 Geantă deschisă": "bag_open",
    "👜 Geantă pusă jos": "bag_put",
    "👜 Fermoar de geantă": "bag_zip",
    "🎒 Rucsac": "backpack",
    "🪝 Umeraș": "hanger",
    "🧣 Eșarfă": "scarf",
    "🧦 Șosete": "socks",
    "🧤 Puse mănuși": "gloves_put",
    "👟 Pantofi puși jos": "shoe_put",
    "👟 Scos pantofii": "shoe_takeoff",
    "👟 Cutie de pantofi": "shoe_box",
    "👟 Legat șireturile": "shoelace",
    "🩴 Sandale": "sandals",
    "🤐 Fermoar": "zipper",
    # 🏠 Casă și obiecte
    "🥛 Pahar pus pe masă": "glass_put",
    "🥂 Pahare atingându-se": "glass_touch",
    "🍶 Atins ceramică": "ceramic_touch",
    "🍾 Capac de sticlă": "bottle_cap",
    "📦 Cutie deschisă": "box_open",
    "📦 Cutie închisă": "box_close",
    "📦 Obiect pus jos": "object_put",
    "📦 Obiect ridicat": "object_lift",
    "📦 Obiect căzând": "object_fall",
    "💥 Obiect spart": "object_break",
    "🪑 Mutat mobila": "furniture_move",
    "🪑 Scaun tras": "chair_pull",
    "🪑 Scaun împins": "chair_push",
    "🪑 Scaune mutate": "chairs_move",
    "🪵 Podea scârțâind": "floor_creak",
    "🪵 Atins masa": "table_touch",
    "🪵 Lovitură de lemn": "wood_hit",
    "🔧 Lovitură de metal": "metal_hit",
    "👊 Lovitură": "hit",
    "📦 Ambalaj": "packaging",
    "🎁 Desfăcut ambalaj": "unwrap",
    "📼 Desprins bandă adezivă": "tape_peel",
    "🛁 Cadă umplându-se": "bath_fill",
    "🕳️ Scurgere de apă": "drain",
    "🚰 Chiuvetă cu apă": "sink_water",
    "🥤 Clătit pahar": "rinse_cup",
    "🚽 Toaletă trasă": "toilet_flush",
    "🚽 Capac de toaletă": "toilet_seat",
    "🪥 Periuță de dinți": "toothbrush",
    "🧽 Burete": "sponge",
    "🧼 Spumă de săpun": "foam",
    "🧽 Șters tabla": "board_wipe",
    "🧴 Dezinfectant de mâini": "sanitizer",
    "🚿 Udat florile": "watering",
    "🍂 Greblat frunze": "rake",
    "⛏️ Săpat cu lopata": "shovel",
    "🛒 Roabă": "wheelbarrow",
    # 🛏️ Camere și spații
    "🛏️ Dormitor liniștit": "bedroom",
    "🏠 Casă liniștită": "quiet_house",
    "🏠 Casă plină de viață": "busy_house",
    "👥 Cameră aglomerată": "crowded_room",
    "📦 Spațiu gol": "empty_space",
    "🏛️ Sală cu ecou mare": "big_echo",
    "🚪 Cameră mică cu ecou": "small_echo",
    "🚶 Pași pe hol": "hall_steps",
    "🚶 Coridor lung cu ecou": "long_corridor",
    "🏨 Coridor de hotel": "hotel_corridor",
    "🛗 Lift de hotel": "hotel_lift",
    "💺 Scaun de salon": "salon_chair",
    "🌳 Parc liniștit": "park_space",
    "🏖️ Șezlong": "lounger",
    "🏪 Piață în aer liber": "market_square",
    "🎭 Scenă": "stage",
    "🎤 Microfon": "microphone",
    "🔊 Microfonie difuzor": "speaker_feedback",
    "📽️ Proiector": "projector",
    "⚙️ Mecanism": "mechanism",
    "🔊 Bip electronic": "beep_electronic",
    "🚨 Alarmă sonoră": "alarm_effect",
    "📳 Bâzâit": "buzz",
    "📳 Vibrație de telefon": "vibration",
    # 🖥️ Birou și școală
    "⌨️ Tastat la calculator": "computer_typing",
    "☎️ Telefon de birou": "desk_phone",
    "🖨️ Imprimantă în birou": "printer_extra",
    "📓 Caiet": "notebook",
    "✍️ Scris cu pixul": "pen_write",
    "📖 Foaie întoarsă": "page_turn",
    "📄 Pagină ruptă": "page_rip",
    "📄 Hârtie ruptă": "paper_rip",
    "📄 Foșnet de hârtie": "paper_rustle",
    "✍️ Zgâriat": "scratch",
    "✂️ Foarfece": "scissors",
    "🖍️ Cretă pe tablă": "chalk_board",
    "🔔 Clopoțel de școală": "school_bell",
    "🎓 Studenți în pauză": "students",
    "🧒 Copii vorbind": "children",
    # 🩺 Medical
    "💓 Bătăi rapide de inimă": "heartbeat_fast",
    "🩺 Monitor medical": "monitor_beep",
    "🚨 Alarmă de monitor": "monitor_alarm",
    "🩺 Tensiometru": "blood_pressure",
    "🩺 Ascultat la stetoscop": "stethoscope",
    "💉 Seringă": "syringe",
    "🧤 Mănuși medicale": "medical_gloves",
    "💊 Pachet medical": "medical_pack",
    "🚑 Targă": "stretcher",
    "♿ Scaun cu rotile": "wheelchair",
    # 👣 Pași și mișcare
    "👣 Pași pe podea": "footsteps_floor",
    "👣 Pași pe piatră": "footsteps_stone",
    "👣 Pași prin dressing": "footsteps_dressing",
    "🪨 Pași pe pietriș": "gravel",
    "💦 Pași prin apă": "water_step",
    "👠 Tocuri răsunând pe parchet": "heels_parquet",
    "🚶 Oameni mergând": "people_walk",
    "👥 Mulțime în mișcare": "crowd_moving",
    "🏃 Oameni alergând": "people_run",
    "🗣️ Voci în depărtare": "distant_people",
    "🧍 Ridicat în picioare": "stand_up",
    "💃 Dans": "dance",
    "⚽ Minge săltând": "ball_bounce",
    "🛝 Tobogan": "slide",
    # 😊 Reacții umane
    "😄 Râs vesel": "laugh",
    "😊 Chicotit": "giggle",
    ...
    "🤫 Șoaptă": "whisper",
    "😗 Fluierat": "whistle",
    "😢 Plâns încet": "cry_soft",
    "😭 Plâns puternic": "cry_loud",
    "😢 Lacrimă": "tear",
    "😠 Huiduieli": "boo",
    "👏 Aplauze ușoare": "applause_soft",
    "😌 Respirație calmă": "breath_calm",
    "😮‍💨 Respirație agitată": "breath_agitated",
    "🤲 Frecat mâinile": "rub",
    "🫨 Tremurat": "tremble",
    # 🐾 Afară și diverse
    "🐾 Animale în depărtare": "animals_far",
    "🪰 Muște bâzâind": "flies",
    "🦟 Țânțari": "mosquitoes",
    "🍖 Grătar": "barbecue",
    "☂️ Umbrelă deschisă": "umbrella",
    "🎸 Rock and roll": "rock_roll",
    "🌱 Mașină de tuns iarba": "lawnmower",
    "🏗️ Șantier mare": "construction_extra",
...
def render_chat(char):
    ...
    with st.expander("🔊 Trimite un sunet ambiental în conversație"):
        ...
        _amb_categories = {
            ...
            # ── 🆕 Categorii noi cu sunete realiste (2026-08) ──
            "🚂 Tren și șine": ["🚂 Tren accelerând", "🚂 Tren frânând", "🚂 Tren plecând din gară", "🚪 Uși de tren", "🚂 Tren care trece", "🚉 Gară cu trenuri", "🚪 Ușă de tren", "📢 Anunț în transport", "📢 Anunț în gară", "🚉 Mulțime în gară"],
            "🚗 Mașini și drum": ["🚗 Portieră de mașină", "🚗 Portbagaj", "🚗 Geam de mașină coborât", "🔒 Centură de siguranță", "🚚 Motor diesel", "🔋 Motor electric", "🚗 Ștergătoare de parbriz", "🚗 Mașini în depărtare", "📯 Claxon în depărtare", "🚨 Sirenă în depărtare", "🚦 Semafor pentru pietoni", "🚦 Semafor sonor", "🚧 Lucrări în stradă", "🔨 Picamer", "🚌 Uși de autobuz", "🛴 Trotinetă", "🌊 Jet ski", "🚤 Barcă accelerând", "⚓ Lanț de ancoră"],
            "✈️ Aeroport și bagaje": ["✈️ Aeroport aglomerat", "✈️ Ușă de avion", "🧳 Bandă de bagaje", "🧳 Cărucior de bagaje", "🧳 Ridicat bagaj", "🧳 Valiză deschisă", "🧳 Valiză cu roți", "🧳 Fermoar de valiză"],
            "🚪 Uși, porți, comutatoare": ["🚪 Ușă închisă încet", "🚪💥 Ușă trântită", "🚪 Ușă scârțâind", "🚪 Clanță apăsată", "🚪 Ușă de cameră", "🚪 Ușă de balcon", "🚪 Ușă de baie", "🚪 Ușă de dulap", "🧊 Ușă de frigider", "🔥 Ușă de cuptor", "🛗 Ușă de lift", "🚪 Ușă de garaj", "🏥 Ușă de clinică", "🚧 Poartă deschisă", "🚧 Poartă închisă", "🚧 Poartă de lemn", "🚪 Dulap deschis", "🪟 Tras perdeaua", "💡 Întrerupător de lumină", "✊ Bătaie în ușă", "🚪 Ceva închis"],
            "🔑 Chei, bani, mărunțișuri": ["🔑 Zornăit de chei", "🔑 Chei căzând", "🔑 Chei puse pe masă", "🔑 Chei în geantă", "🔑 Scotocit după chei", "🪙 Zornăit de monede", "💵 Numărat bani", "👛 Portofel deschis", "💳 Card trecut prin POS", "🔘 Nasture", "🔘 Apăsare de buton", "📎 Agrafă de birou", "🎗️ Elastic", "🔗 Cataramă de curea"],
            "💄 Machiaj și îngrijire": ["💄 Deschis trusa de machiaj", "💄 Închis trusa de machiaj", "💄 Pompă de fond de ten", "💄 Anticearcăn", "👁️ Dat cu rimel", "✏️ Creion de sprâncene", "✨ Aplicat bronzant", "🖌️ Pensulă de machiaj", "🖌️ Pensulă lovită ușor", "🖌️ Perie rotativă", "🌸 Disc demachiant", "💆 Mască de față", "🧴 Aplicat cremă", "🧴 Cremă de mâini", "💧 Picurat ser", "🧴 Pompă de cosmetice", "🧴 Stors tub de cremă", "💨 Pulverizator fin", "🌸 Pulverizare parfum", "🌸 Parfum pe încheietură", "🧴 Spray de corp", "🧴 Spray deodorant", "🧴 Deodorant roll-on", "🧴 Deodorant stick", "💇 Fixativ de păr", "💇 Placă de îndreptat părul", "💇 Pieptene pus jos", "✂️ Tuns părul", "✂️ Mașină de tuns", "💈 Epilator", "🪒 Aparat de ras", "🪒 Aparat de ras electric", "🪞 Oglindă aburită"],
            "💅 Unghii": ["💅 Pilă de unghii", "💅 Unghieră", "💅 Împins cuticulele", "💅 Deschis oja", "💅 Agitat sticluța de ojă", "💅 Pensulă de ojă", "👁️ Lipit gene false", "🔧 Pensetă"],
            "💍 Bijuterii": ["💍 Cutie de bijuterii deschisă", "💍 Cutie de bijuterii închisă", "💍 Zornăit de bijuterii", "📿 Colier", "👂 Cercei", "📿 Brățară", "💍 Inel pus jos"],
            "🧥 Haine și încălțăminte": ["👕 Împăturit haine", "👕 Haine puse jos", "🛍️ Pungă cu haine", "👗 Îmbrăcat", "👗 Foșnet de material", "🧥 Fermoar de geacă", "👢 Fermoar de cizmă", "👜 Geantă deschisă", "👜 Geantă pusă jos", "👜 Fermoar de geantă", "🎒 Rucsac", "🪝 Umeraș", "🧣 Eșarfă", "🧦 Șosete", "🧤 Puse mănuși", "👟 Pantofi puși jos", "👟 Scos pantofii", "👟 Cutie de pantofi", "👟 Legat șireturile", "🩴 Sandale", "🤐 Fermoar"],
            "🏠 Casă și obiecte (realiste)": ["🥛 Pahar pus pe masă", "🥂 Pahare atingându-se", "🍶 Atins ceramică", "🍾 Capac de sticlă", "📦 Cutie deschisă", "📦 Cutie închisă", "📦 Obiect pus jos", "📦 Obiect ridicat", "📦 Obiect căzând", "💥 Obiect spart", "🪑 Mutat mobila", "🪑 Scaun tras", "🪑 Scaun împins", "🪑 Scaune mutate", "🪵 Podea scârțâind", "🪵 Atins masa", "🪵 Lovitură de lemn", "🔧 Lovitură de metal", "👊 Lovitură", "📦 Ambalaj", "🎁 Desfăcut ambalaj", "📼 Desprins bandă adezivă", "🛁 Cadă umplându-se", "🕳️ Scurgere de apă", "🚰 Chiuvetă cu apă", "🥤 Clătit pahar", "🚽 Toaletă trasă", "🚽 Capac de toaletă", "🪥 Periuță de dinți", "🧽 Burete", "🧼 Spumă de săpun", "🧽 Șters tabla", "🧴 Dezinfectant de mâini", "🚿 Udat florile", "🍂 Greblat frunze", "⛏️ Săpat cu lopata", "🛒 Roabă"],
            "🛏️ Camere și spații": ["🛏️ Dormitor liniștit", "🏠 Casă liniștită", "🏠 Casă plină de viață", "👥 Cameră aglomerată", "📦 Spațiu gol", "🏛️ Sală cu ecou mare", "🚪 Cameră mică cu ecou", "🚶 Pași pe hol", "🚶 Coridor lung cu ecou", "🏨 Coridor de hotel", "🛗 Lift de hotel", "💺 Scaun de salon", "🌳 Parc liniștit", "🏖️ Șezlong", "🏪 Piață în aer liber", "🎭 Scenă", "🎤 Microfon", "🔊 Microfonie difuzor", "📽️ Proiector", "⚙️ Mecanism", "🔊 Bip electronic", "🚨 Alarmă sonoră", "📳 Bâzâit", "📳 Vibrație de telefon"],
            "🖥️ Birou și școală": ["⌨️ Tastat la calculator", "☎️ Telefon de birou", "🖨️ Imprimantă în birou", "📓 Caiet", "✍️ Scris cu pixul", "📖 Foaie întoarsă", "📄 Pagină ruptă", "📄 Hârtie ruptă", "📄 Foșnet de hârtie", "✍️ Zgâriat", "✂️ Foarfece", "🖍️ Cretă pe tablă", "🔔 Clopoțel de școală", "🎓 Studenți în pauză", "🧒 Copii vorbind"],
            "🩺 Medical": ["💓 Bătăi rapide de inimă", "🩺 Monitor medical", "🚨 Alarmă de monitor", "🩺 Tensiometru", "🩺 Ascultat la stetoscop", "💉 Seringă", "🧤 Mănuși medicale", "💊 Pachet medical", "🚑 Targă", "♿ Scaun cu rotile"],
            "👣 Pași și mișcare (noi)": ["👣 Pași pe podea", "👣 Pași pe piatră", "👣 Pași prin dressing", "🪨 Pași pe pietriș", "💦 Pași prin apă", "👠 Tocuri răsunând pe parchet", "🚶 Oameni mergând", "👥 Mulțime în mișcare", "🏃 Oameni alergând", "🗣️ Voci în depărtare", "🧍 Ridicat în picioare", "💃 Dans", "⚽ Minge săltând", "🛝 Tobogan"],
            "😊 Reacții umane": ["😄 Râs vesel", "😊 Chicotit", "😮‍💨 Oftat", "🤫 Șoaptă", "😗 Fluierat", "😢 Plâns încet", "😭 Plâns puternic", "😢 Lacrimă", "😠 Huiduieli", "👏 Aplauze ușoare", "😌 Respirație calmă", "😮‍💨 Respirație agitată", "🤲 Frecat mâinile", "🫨 Tremurat"],
            "🐾 Afară și diverse (noi)": ["🐾 Animale în depărtare", "🪰 Muște bâzâind", "🦟 Țânțari", "🍖 Grătar", "☂️ Umbrelă deschisă", "🎸 Rock and roll", "🌱 Mașină de tuns iarba", "🏗️ Șantier mare"],
        }
